...
RCT_EXPORT_METHOD(decodeLesson:(NSString*)relativePath inStorage:(NSString*)storage resolver:(RCTPromiseResolveBlock)resolve rejecter:(RCTPromiseRejectBlock)reject) {
  BOOL decodeLesson = [RNFileSystem decodeLesson:relativePath inStorage:storage];
  resolve([NSNumber numberWithBool:decodeLesson]);
}
